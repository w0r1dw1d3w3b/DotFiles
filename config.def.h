...
static const float rootcolor[]             = COLOR(0xff5733ff);
static const float bordercolor[]           = COLOR(0xEE4B2Bff);
static const float focuscolor[]            = COLOR(0xFF3131ff);
static const float urgentcolor[]           = COLOR(0xE34234ff);
...
static const char *menucmd[] = { "Rofi-Drun", NULL };
